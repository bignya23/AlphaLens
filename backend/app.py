...
from src.model_analysis import fundamental_gemini, analysis_gemini, news_fetcher
...
from src.chatbot.model import get_response
...
def handle_fetch_data(data):
    ...
    # Bullish View
    try:
        bullishView = analysis_gemini.bullish(headlines_df)
    ...
    # Bearish View
    try:
        bearishView = analysis_gemini.bearish(headlines_df)
    ...
    try:
        summary_and_insights = analysis_gemini.investment_insights(headlines_df)
    ...
    try:
        fundamental_summary = fundamental_gemini.generate_summary_and_insights_from_fundamentals(advanced_info)
